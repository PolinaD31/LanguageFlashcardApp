...
public class WebSecurityConfig  {
	...
	public SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests(authorize -> authorize
				...
				.requestMatchers(antMatcher("/forgot_password")).permitAll()
				.requestMatchers(antMatcher("/reset_password/**")).permitAll()
				.requestMatchers(antMatcher("/reset_password")).permitAll()
				.requestMatchers(antMatcher("/verify_email/**")).permitAll()
				.requestMatchers(antMatcher("/verify_email")).permitAll()
